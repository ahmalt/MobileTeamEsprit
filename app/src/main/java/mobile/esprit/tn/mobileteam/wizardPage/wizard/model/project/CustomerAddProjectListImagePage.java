...
import mobile.esprit.tn.mobileteam.wizardPage.wizard.fragments.project.CustomerAddProjetImageFragment;
 ...
 */
public class CustomerAddProjectListImagePage extends Page {
    public static final String IMAGE_DATA_KEY = "image";

    public CustomerAddProjectListImagePage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return CustomerAddProjetListImageFragment.create(getKey());
    }
    ...
    public CustomerAddProjectListImagePage setValue(String value) {
