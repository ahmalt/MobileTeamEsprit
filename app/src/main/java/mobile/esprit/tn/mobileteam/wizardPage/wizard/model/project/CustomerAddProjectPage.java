 ...
 */
public class CustomerAddProjectPage extends Page {
    ...
    public static final String TECHNOLOGIE_DATA_KEY = "technologie";
    public static final String HEURE_DATA_KEY = "heure";




    public CustomerAddProjectPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return CustomerAddProjectFragment.create(getKey());
    }
    ...
    public void getReviewItems(ArrayList<ReviewItem> dest) {
        ...
        dest.add(new ReviewItem("heure", mData.getString(HEURE_DATA_KEY), getKey(), -1));
        dest.add(new ReviewItem("technologie", mData.getString(TECHNOLOGIE_DATA_KEY), getKey(), -1));
    ...
    public boolean isCompleted() {
        return ((!TextUtils.isEmpty(mData.getString(NOM_DATA_KEY))) &&
                ...
                (!TextUtils.isEmpty(mData.getString(TECHNOLOGIE_DATA_KEY)))&&
                (!TextUtils.isEmpty(mData.getString(HEURE_DATA_KEY)))&&
