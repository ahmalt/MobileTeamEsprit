...
public class AddNewsActivity extends FragmentActivity implements
        PageFragmentCallbacks,
        ReviewFragment.Callbacks,
        ModelCallbacks {
   // String cle = TeamUpApp.getInstance().getPrefManager().getApiKey();

    String nom, desc , date,heure;
    String choix;
    ...
    private AbstractWizardModel mWizardModel = new AddNewsWizardModel(this);
...
//                    dg.show(getSupportFragmentManager(), "place_order_dialog");
    ...
    public  void recherche() {
        ...
        Log.i(TAG, "choix = " + lista.get(3).getDisplayValue().toString());
             ...
             if (lista.get(6).getDisplayValue().toString() == "Actualités"){
            nom = lista.get(0).getDisplayValue().toString();
            desc = lista.get(1).getDisplayValue().toString();
            //image = TeamUp.getInstance().getPrefManager().getImageArticle();
            date = lista.get(2).getDisplayValue().toString();
            heure = lista.get(3).getDisplayValue().toString();
