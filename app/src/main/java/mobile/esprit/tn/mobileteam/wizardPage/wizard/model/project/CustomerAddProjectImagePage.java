 ...
 */
public class CustomerAddProjectImagePage extends Page {
    public static final String IMAGE_DATA_KEY = "image";

    public CustomerAddProjectImagePage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return CustomerAddProjetImageFragment.create(getKey());
    }
    ...
    public CustomerAddProjectImagePage setValue(String value) {
