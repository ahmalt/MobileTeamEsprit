...
package mobile.esprit.tn.mobileteam.wizardPage.wizard.model.news;
 ...
 */
public class CustomerAddNewsPage extends Page {
    ...
    public CustomerAddNewsPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return CustomerAddNewsFragment.create(getKey());
    }
