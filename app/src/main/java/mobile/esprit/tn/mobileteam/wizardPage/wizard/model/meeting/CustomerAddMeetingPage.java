...
import mobile.esprit.tn.mobileteam.wizardPage.wizard.fragments.meeting.CustomerAddMeetingFragment;
 ...
 */
public class CustomerAddMeetingPage extends Page {
    ...
    public CustomerAddMeetingPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return CustomerAddMeetingFragment.create(getKey());
    }
