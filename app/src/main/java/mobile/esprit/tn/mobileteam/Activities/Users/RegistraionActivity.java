...
public class RegistraionActivity extends Activity {
...
//end of backendless initialisation
    ...
    public LoadingCallback<BackendlessUser> createRegistrationCallback() {
        return new LoadingCallback<BackendlessUser>(this, getString(R.string.loading_register)) {
            ...
            public void handleResponse(BackendlessUser registeredUser) {
                ...
                Toast.makeText(RegistraionActivity.this, String.format(getString(R.string.info_registered), registeredUser.getObjectId()), Toast.LENGTH_LONG).show();
            }
        };
    }
