...
import mobile.esprit.tn.mobileteam.wizardPage.activty_wizard.projet.AddProjectWizardModel;
...
public class AddMeetingActivity extends FragmentActivity implements
        PageFragmentCallbacks,
        ReviewFragment.Callbacks,
        ModelCallbacks {
   // String cle = TeamUpApp.getInstance().getPrefManager().getApiKey();

    String nom, date_start , heure_start,date_end, heure_end,membre, projet,choix;
    ...
    private AbstractWizardModel mWizardModel = new AddMeetingWizardModel(this);
...
//                    dg.show(getSupportFragmentManager(), "place_order_dialog");
    ...
    public  void recherche() {
        ...
        Log.i(TAG, "choix = " + lista.get(5).getDisplayValue().toString());

        if (lista.get(5).getDisplayValue().toString() == "Meeting") {
            nom = lista.get(0).getDisplayValue().toString();
            date_start = lista.get(1).getDisplayValue().toString();
            heure_start = lista.get(2).getDisplayValue().toString();
            date_end = lista.get(3).getDisplayValue().toString();
            heure_end = lista.get(4).getDisplayValue().toString();
            membre = lista.get(5).getDisplayValue().toString();
            projet = lista.get(6).getDisplayValue().toString();
