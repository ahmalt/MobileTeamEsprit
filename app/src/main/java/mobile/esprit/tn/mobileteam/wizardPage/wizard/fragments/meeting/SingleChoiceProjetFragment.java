...
public class SingleChoiceProjetFragment extends ListFragment {
    private static final String ARG_KEY = "key";
    String TAG=SingleChoiceProjetFragment.class.getSimpleName();
    private ArrayList<Project> projectArrayList;
    private PageFragmentCallbacks mCallbacks;
    private List<String> mChoices;
    private String mKey;
    private Page mPage;
    SingleFixedChoiceProjetPage fixedChoicePage;


    public static SingleChoiceProjetFragment create(String key) {
        Bundle args = new Bundle();
        args.putString(ARG_KEY, key);

        SingleChoiceProjetFragment fragment = new SingleChoiceProjetFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public SingleChoiceProjetFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fixedChoicePage = (SingleFixedChoiceProjetPage) mPage;

        projectArrayList= new ArrayList<>();
        projectArrayList=fixedChoicePage.getList_projets();
        if(projectArrayList.isEmpty()) {
            AlertDialog.Builder builder1 = new AlertDialog.Builder(getActivity());
            builder1.setMessage("NO PROJECT TO DISPLAY.");
        ...
        {
            fixedChoicePage.setChoices(projectArrayList.get(i));
