...
package mobile.esprit.tn.mobileteam.wizardPage.wizard.ui;
...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    ...
    private static List<ReviewItem> mCurrentReviewItems;
    ...
    public static List<ReviewItem> getAll(){
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            if (TextUtils.isEmpty(value)) {
                value = "";
                reviewItem.setDisplayValue(value);
            }
